...
1. Adjacency Matrix
   ...
   - O(n^2)의 공간복잡도를 갖는다.<br>
     ...
     ![Adjacency Matrix](./img/graph_adjacency_matrix.png)
...
2. Adjacenty List
   ...
   - O(n+e)의 공간 복잡도를 갖는다. (n: vertex의 갯수, e:edge의 갯수)
     ...
     ![Adjacency List](./img/graph_adjacency_list.png)
...
1.  Depth-First Search (DFS)
    ...
    - 깊이 우선 탐색 방식은 시작 Node 기준으로 다음 각각의 branch들을 다 검사하고 다음 branch로 넘어가서 검사하는 방식이다.
        ...
        <img src='./img/dfs.gif' alt='Depth-First Search' style='width:350px;'/>
...
2. Breadth-First Search (BFS)
   ...
   - 넓이 우선 탐색 방식은 시작 Node 기준으로 바로 인접한 모든 branch들을 먼저 다 검사하고 그 다음에 branch의 branch로 넘어가서 똑같은 방식으로 검사하는 방식이다.
    ...
    <img src='./img/bfs.gif' alt='Breadth-First Search' style='width:350px;'/>
